                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <p className="text-gray-400">
                                        Mail us: <a href="mailto:cmo@ytpr.in" className="text-blue-400 hover:underline">cmo@ytpr.in</a>
                                    </p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-300">Our Location</h3>
                                            <p className="text-gray-400">
                                                C-84, Sector 2<br />
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+919999944807" className="text-gray-400 hover:underline">
                                                +91 99999 44807
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:cmo@ytpr.in" className="text-gray-400 hover:underline">
                                                cmo@ytpr.in
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-300 mb-3">Follow Us</h3>
